...
```{r}
# Esta grafica la tomamos de https://statisticsglobe.com/histogram-density-for-each-column-data-frame-r
data_long <- df_train[, -9] %>%                          # Apply pivot_longer function
...
2. Tanto el rendimiento académico, como las habilidades de comunicación, no son simétricas
    - En el caso de las habilidades de comunicación, con más concentración hacia la izquierda
    - En el caso del rendimiento académico, casi todos los candidatos tienen una valoración de 5
