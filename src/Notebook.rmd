...
Aplicamos la misma transformación (con parámetros aprendidos sobre el entrenamiento) al conjunto de test:

<!-- TODO -- BUG -- esto esta mal, porque no estoy aplicando lo mismo -->

```{r}
# TODO -- BUG -- esto esta mal
# df_test_fa <- df_train_fa_varimax$scores
