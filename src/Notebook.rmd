...
```{r}
# Calculamos los accuracy
train_accuracy <- get_accuracy(df_train[, 1:8], df_train$CLASS, modelo_qda)
test_accuracy <- get_accuracy(df_test[, 1:8], df_test$CLASS, modelo_qda)
...
Empezamos viendo los valores de *accuracy*:
